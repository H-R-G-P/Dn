...
final class Version20220111145356 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE version DROP department_id, DROP region_id, DROP is_rec, DROP is_imp, DROP source_id_2, DROP is_correct_place, DROP has_local_video, DROP youtube_2, DROP vk, DROP comments, DROP adrady, DROP is_game, DROP drob');
    }
}
