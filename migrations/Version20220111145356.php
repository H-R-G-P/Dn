...
final class Version20220111145356 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE version ADD department_id INT DEFAULT NULL, ADD region_id INT DEFAULT NULL, ADD is_rec TINYINT(1) NOT NULL, ADD is_imp TINYINT(1) NOT NULL, ADD source_id_2 VARCHAR(255) NOT NULL, ADD is_correct_place TINYINT(1) NOT NULL, ADD has_local_video TINYINT(1) NOT NULL, ADD youtube_2 VARCHAR(255) NOT NULL, ADD vk VARCHAR(255) NOT NULL, ADD comments VARCHAR(255) NOT NULL, ADD adrady VARCHAR(255) NOT NULL, ADD is_game TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE version DROP department_id, DROP region_id, DROP is_rec, DROP is_imp, DROP source_id_2, DROP is_correct_place, DROP has_local_video, DROP youtube_2, DROP vk, DROP comments, DROP adrady, DROP is_game');
    }
}
